...
AWS cuenta con varios tipos de instancias dependiendo de las necesidades muy específicas de la aplicación, tenemos:
...
Una AMI es una maquina virtual pre configurada, usada para crear una maquina virtual.
...
- El cómputo en la nube es accesible desde la pequeña y mediana empresa hasya multinacionales con presupuestos millonarios, tener la capacidad de contratar cómputo para mejorar y ser inovador en procesos en menos de un día (en cómputo en sitio podía llevar semanas o meses) es un antes y un despúes en el uso de recursos computacionales.
...
Indudablemente el cómputo en la nube nos ayudará a generar resultados mas rápidos, adaptandose a la realidad y necesidades que el software tiene hoy día.


# Organización y optimización de costos en AWS
Una estrategia de ahorro es imprecindible a la hora de tener recursos de computo ya sea en la nube o en sitio.
...
Son identificadores de texto que podemos asignar a recursos de AWS que usamos. por ejemplo: 
La siguiente instancia tiene una etiqueta que me ayuda a saber que es un entorno de producción y el departamento asignado apra ese recurso es Recursos humanos.
