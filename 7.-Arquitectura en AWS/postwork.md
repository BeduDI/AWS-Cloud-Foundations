...
![pw-vpc-menu-access-01.png](pw-vpc-menu-access-01.png)

2. Dirigirse a la sección de Grupos de seguridad
![pw-vpc-access-security-groups-01.png](pw-vpc-access-security-groups-01.png)

3. Crear un nuevo grupo de seguridad
![pw-vpc-create-new-security-group-01.png](pw-vpc-create-new-security-group-01.png)
...
![pw-vpc-new-security-group-01.png](pw-vpc-new-security-group-01.png)
...
![pw-vpc-security-group-done-01.png](pw-vpc-security-group-done-01.png)
...
![pw-code-build-start-compilation-01.png](pw-code-build-start-compilation-01.png)

Se Abrirá una ventana con los datos para iniciar el proceso, basta con simplemente "Iniciar la compilación"

![pw-code-build-start-compilation-02.png](pw-code-build-start-compilation-02.png)


Se iniciará el trabajo de compilación 

![pw-code-build-compilation-stage-started-01.png](pw-code-build-compilation-stage-started-01.png)


Después de un par de minutos se confirma que el trabajo fue creado satisfactoriamente

![pw-code-build-job-done-01.png](pw-code-build-job-done-01.png)
...
![pw-ecs-cluster-instances-created-done-01.png](pw-ecs-cluster-instances-created-done-01.png)
...
![pw-ecs-tas-definition-01.png](pw-ecs-tas-definition-01.png)

2. Seleccionar una tarea compatible con instancias EC2.

![pw-ecs-select-ec2-type-task-01.png](pw-ecs-select-ec2-type-task-01.png)
...
![pw-ecs-configure-task-01.png](pw-ecs-configure-task-01.png)
...
![pw-ecs-configure-task-02.png](pw-ecs-configure-task-02.png)

a) Se procederá a configurar el contenedor que será ejecutado en esta tarea

![pw-ecs-configure-task-03.png](pw-ecs-configure-task-03.png)
...
![pw-ecs-task-config-container-01.png](pw-ecs-task-config-container-01.png)
...
![pw-ecs-task-config-container-02.png](pw-ecs-task-config-container-02.png)


Los otros parámetros del contenedor se pueden dejar por defecto. Click en "Add"

![pw-ecs-task-config-container-05.png](pw-ecs-task-config-container-05.png)


Los parámetros de la tarea de ejecución que siguen para configurar deben quedar como se aprecia en la imagen.
 Click en "Create"

![pw-ecs-task-configure-task-done-01.png](pw-ecs-task-configure-task-done-01.png)
...
![pw-ecs-configure-service-01.png](pw-ecs-configure-service-01.png)


2. a) Seleccionar "Services", b) Click en el botón "Create"

![pw-ecs-configure-service-02.png](pw-ecs-configure-service-02.png)
...
![pw-ecs-configure-service-03.png](pw-ecs-configure-service-03.png)
...
![pw-ecs-configure-service-04.png](pw-ecs-configure-service-04.png)
...
![pw-ec2-target-group-instances-asociated-01.png](pw-ec2-target-group-instances-asociated-01.png)
...
![pw-application-is-running-yay-01.png](pw-application-is-running-yay-01.png)
...
![pw-code-pipe-line-service-01.png](pw-code-pipe-line-service-01.png)


2. Seleccionar "Crear la canalización"

![pw-pipeline-create-pipeline-01.png](pw-pipeline-create-pipeline-01.png)
...
![pw-pipeline-configure-pipe-01.png](pw-pipeline-configure-pipe-01.png)
...
![pw-code-pipe-add-origin-to-pipe-01.png](pw-code-pipe-add-origin-to-pipe-01.png)
...
![pw-code-pipe-specify-build-steps-01.png](pw-code-pipe-specify-build-steps-01.png)
...
![pw-code-pipe-add-deploy-step-01.png](pw-code-pipe-add-deploy-step-01.png)


Al pasar por el review de la aplicación y estar conforme con los parámetros se puede dar click en "Crear la canalización"

![pw-code-pipe-review-config-01.png](pw-code-pipe-review-config-01.png)



Un Proceso nuevo de despliegue comienza a ejecutarse:

![pw-codepipeline-deplot-application-on-pipe-creation-01.png](pw-codepipeline-deplot-application-on-pipe-creation-01.png)
...
![pw-codepipe-ecs-deploy-service-01.png](pw-codepipe-ecs-deploy-service-01.png)


En los eventos del servicio se pueden ir viendo todos los pasos que orquestan el despliegue del código.

![pw-ecs-service-events-01.png](pw-ecs-service-events-01.png)


Después de unos 10 minutos ser ve como el proceso de despliegue es exitoso.
![pw-codepipe-is-complete-yay-01.png](pw-codepipe-is-complete-yay-01.png)
...
![pw-git-push-to-test-deploy-01.png](pw-git-push-to-test-deploy-01.png)
...
![pw-code-deployed-tested-rest-done-01.png](pw-code-deployed-tested-rest-done-01.png)
